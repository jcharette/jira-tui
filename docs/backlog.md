...
- Continue focused ticket detail workspace work: contextual footer commands and remaining
  metadata-backed implementations behind the Actions tab, especially Subtask creation and
  less-common actions.
