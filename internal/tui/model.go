...
type Model struct {
	...
	eventConsumers                     []func(events.Event)
...
func WithEventConsumer(consumer func(events.Event)) Option {
	return func(m *Model) {
		if consumer == nil {
			return
		}
...
func (m Model) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	...
	case appEventMsg:
		...
		m.recordNotification(msg.event)
		for _, consumeEvent := range m.eventConsumers {
			consumeEvent(msg.event)
		}
	...
	case tea.KeyMsg:
		...
		if m.notificationPanelOpen {
			return m.updateNotificationPanel(msg)
		}
...
func (m Model) render() string {
	...
	if summary := m.renderNotificationSummary(layout); summary != "" {
		b.WriteString("\n")
	...
	if m.notificationPanelOpen {
		b.WriteString(m.renderNotificationCenter(layout))
		b.WriteString("\n\n")
		b.WriteString(m.renderFooterHelp(keyContextNotifications, layout))
		return b.String()
	}
